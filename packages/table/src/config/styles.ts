...
export const defaultStyles: TableStyles = {
  thead: 'divide-y divide-zinc-300 dark:divide-zinc-600',
  tbody: 'divide-y divide-zinc-200 dark:divide-zinc-600',
  table: 'min-w-full divide-y divide-zinc-300 dark:divide-zinc-600',
  tableStyles:
    'mt-4 flex flex-col rounded-xl border bg-zinc-100  shadow-2xl dark:bg-zinc-900 dark:border-zinc-600 overflow-hidden',
  tableHeaderClasses:
