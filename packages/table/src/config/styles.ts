...
export const defaultStyles: TableStyles = {
  ...
  tableCellStyles: 'px-6 py-3 whitespace-nowrap text-sm text-gray-900',
  noDataStyles: 'text-center text-gray-500 dark:text-gray-400',
  checkboxStyles: 'h-4 w-4 rounded border-gray-300 bg-gray-100 text-blue-600',
  tableFooterStyles: '',
  tableStyles:
    'mt-4 flex flex-col rounded-xl border bg-zinc-100 p-2 shadow-2xl',
};
